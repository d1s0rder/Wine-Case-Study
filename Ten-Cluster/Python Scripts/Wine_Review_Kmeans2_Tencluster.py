...
fig.savefig('Silhouette_Kmeans2_Ten_Cluster.png')

kmeans_10 = KMeans(n_clusters = 10)
kmeans_10.fit(wine_no_text_combine)
silhouette_score(wine_no_text_combine, kmeans_10.labels_)
...
normal_result.to_csv('kmeans2_ten_cluster.csv')
